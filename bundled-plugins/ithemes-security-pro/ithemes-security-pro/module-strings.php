...
__( 'Protect your site with automated site scans. When this feature is enabled, the site will be automatically scanned four times daily (hourly for Pro). If a problem is found, an email is sent to select users.', 'it-l10n-ithemes-security-pro' );
__( 'Vulnerability Notification Threshold', 'it-l10n-ithemes-security-pro' );
__( 'Choose what types of vulnerabilities should be included in the site scan notification.', 'it-l10n-ithemes-security-pro' );
__( 'All', 'it-l10n-ithemes-security-pro' );
__( 'Medium and high priority', 'it-l10n-ithemes-security-pro' );
__( 'High priority only', 'it-l10n-ithemes-security-pro' );
...
__( 'Email users a Magic Link they can use to log in with one click.', 'it-l10n-ithemes-security-pro' );
__( 'Passkeys', 'it-l10n-ithemes-security-pro' );
__( 'Users can log in with biometrics like Face ID, Touch ID, Windows Hello, or any passkey their device supports.', 'it-l10n-ithemes-security-pro' );
...
# BEGIN MODULE: restrict-admin-access
__( 'Restrict Admin Access by Country', 'it-l10n-ithemes-security-pro' );
__( 'Only allow administrator logins from approved geographic locations to prevent unauthorized access.', 'it-l10n-ithemes-security-pro' );
__( 'To prevent a lockout, add your IP and country to the Authorized IPs list before enabling this feature. This restriction applies to all users with administrator capabilities. Note: Magic Links and other bypass mechanisms may still allow access.', 'it-l10n-ithemes-security-pro' );
__( 'restrict', 'it-l10n-ithemes-security-pro' );
__( 'admin', 'it-l10n-ithemes-security-pro' );
__( 'country', 'it-l10n-ithemes-security-pro' );
__( 'ip', 'it-l10n-ithemes-security-pro' );
__( 'Authorized Administrator Countries', 'it-l10n-ithemes-security-pro' );
__( 'Select which countries administrators are permitted to login from. This restriction only applies to users with administrator capabilities and requires a configured geolocation provider.', 'it-l10n-ithemes-security-pro' );
# END MODULE: restrict-admin-access

# BEGIN MODULE: security-headers
__( 'Security Headers', 'it-l10n-ithemes-security-pro' );
__( 'Secure your site and visitors by enforcing essential HTTP security headers.', 'it-l10n-ithemes-security-pro' );
__( 'Use server configuration to send headers', 'it-l10n-ithemes-security-pro' );
__( 'By default, security headers are sent via PHP. Enable this to inject headers directly into your server configuration (NGINX/Apache).', 'it-l10n-ithemes-security-pro' );
__( 'X-Frame-Options', 'it-l10n-ithemes-security-pro' );
__( 'Prevent your site from being displayed inside another website using frames, helping protect against clickjacking attacks. <a href=\'https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/X-Frame-Options\' target=\'_blank\'>Learn more</a>.', 'it-l10n-ithemes-security-pro' );
__( 'X-Content-Type-Options', 'it-l10n-ithemes-security-pro' );
__( 'Tell browsers not to guess file types, helping block malicious files from being run as something they’re not. <a href=\'https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/X-Content-Type-Options\' target=\'_blank\'>Learn more</a>.', 'it-l10n-ithemes-security-pro' );
__( 'Referrer-Policy', 'it-l10n-ithemes-security-pro' );
__( 'Controls how much information about your visitors’ previous pages is shared when they follow links. <a href=\'https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Referrer-Policy\' target=\'_blank\'>Learn more</a>.', 'it-l10n-ithemes-security-pro' );
__( 'Content-Security-Policy', 'it-l10n-ithemes-security-pro' );
__( 'Adds strong protection by limiting which domains browsers can load scripts, styles, and other content from. <a href=\'https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Content-Security-Policy\' target=\'_blank\'>Learn more</a>.<br>Use <a href=\'https://report-uri.com/home/generate\' target=\'_blank\'>report-uri.com</a> to create your policy, then paste it here.', 'it-l10n-ithemes-security-pro' );
__( 'Clickjacking', 'it-l10n-ithemes-security-pro' );
__( 'Response Headers', 'it-l10n-ithemes-security-pro' );
__( 'Resource Control', 'it-l10n-ithemes-security-pro' );
# END MODULE: security-headers
